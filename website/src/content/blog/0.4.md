...
The `Portal` component animates an element from one place to another. You wrap your element in `Portal::new(id)` and, when a portal with the same id shows up somewhere else in the app, the element smoothly moves from its old position to the new one. You can tweak the easing and duration.

See the [kanban board example](https://github.com/marc2332/freya/blob/main/examples/kanban.rs), where cards animate between columns as you drag them.
...
<video muted autoplay playsinline loop controls >
    <source src="https://github.com/user-attachments/assets/9337d986-976e-4311-a102-d8ace1884919" type="video/mp4" >
</video>
...
See [`feature_transform.rs`](https://github.com/marc2332/freya/blob/main/examples/feature_transform.rs) for a complete example.
...
<div align="center">
  <img src="/blog/0.4/docking.png" width="550px">
</div>
...
<div align="center">
  <img src="/blog/0.4/contextmenu.png">
</div>
...
<div align="center">
  <img src="/blog/0.4/colorpicker.png">
</div>
...
<div align="center">
  <img src="/blog/0.4/markdown.png" width="550px">
</div>
...
<div align="center">
  <img src="/blog/0.4/performance.png">
</div>
...
<div align="center">
  <img src="/blog/0.4/android.png" width="300px">
</div>
...
Dogfooding code editor built on top of the `freya-code-editor` and other APIs like e.g docking.
