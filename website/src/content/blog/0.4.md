...
Sanctum is my own (but heavily assisted with AI) Linux Desktop Environment. It consists of a compositor using using smithay, shell (dock, control panel, etc) and apps (settings app, file explorer and process monitor). 
